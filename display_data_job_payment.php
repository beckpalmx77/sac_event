...
if (strlen($_SESSION['alogin']) == "") {
    ...
    $sql_year = " SELECT DISTINCT(effect_year) AS effect_year
 FROM v_job_transaction__summary 
 order by effect_year desc ";
                                                                ...
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    <select name="year" id="year" class="form-control" required>
                                                                        <?php foreach ($YearRecords as $row) { ?>
                                                                            <option value="<?php echo $row["effect_year"]; ?>">
                                                                                <?php echo $row["effect_year"]; ?>
                                                                            </option>
                                                                        <?php } ?>
                                                                    </select>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-12">
                                                                            <button type="button" id="BtnSale" name="BtnSale" class="btn btn-primary mb-3">สรุปข้อมูล
                                                                            </button>
                                                                        </div>
                                                                    </div>
    ...
    <script>
        ...
        $("#BtnSale").click(function () {
            document.forms['myform'].action = 'show_data_job_payment';
